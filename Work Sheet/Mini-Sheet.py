...
final_df = filtered_df[['OrderID: ', 'Phone: ', 'Package: ', 'Department: ', 
                        'Delivery Status: ', 'Confirmation Date: ', 'ETA: ']].copy()
...
output_file = f"Sheet {today_date}.xlsx"
...
ws.column_dimensions['E'].width = 75.00
ws.column_dimensions['F'].width = 50.00
